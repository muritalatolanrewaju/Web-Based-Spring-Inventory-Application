...
class PartTest {
    ...
    @Test
    void testMaxInventoryField() {
        int maxInventoryVal = 100;
        partIn.setMaxInventory(maxInventoryVal);
        assertEquals(maxInventoryVal, partIn.getMaxInventory());
        partOut.setMaxInventory(maxInventoryVal);
        assertEquals(maxInventoryVal, partOut.getMaxInventory());
    }
    @Test
    void testMinInventoryField() {
        int minInventoryVal = 10;
        partIn.setMinInventory(minInventoryVal);
        assertEquals(minInventoryVal, partIn.getMinInventory());
        partOut.setMinInventory(minInventoryVal);
        assertEquals(minInventoryVal, partOut.getMinInventory());
    }
    @Test
    void getId() {
        Long idValue=4L;
